...
namespace Drupal\demo_migrate_content\Form;
...
final class ImportNewsForm extends FormBase {
  ...
  public function getFormId(): string {
    return 'demo_migrate_content_import_news';
  }
  ...
  public function startImport(array &$form, FormStateInterface $form_state) {
    ...
    $module_path = $base_path . '/'. \Drupal::service('extension.list.module')->getPath('demo_migrate_content');
